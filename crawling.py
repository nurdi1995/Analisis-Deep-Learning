...
def load_api():
    ...
    consumer_key = 'WjYADj0Xn5Y5aJMVArYyDK7Gy'
    consumer_secret = 'GvEKLZzHNpf6uFfUCI5W0Oc5TkFvdfVb3p1mcQwSGkxTQlOdBA'
    access_token = '114660262-BGZse191OjsfTjmgNBNzvz1P1fS2lq4M7GIP8FET'
    access_secret = 'ZA0w6X4QOCExKlgiWvebrYkFxff13RGqlZgqziFalA18K'
...
def main():
    ...
    ''' search variables: '''
    search_phrases = ['#INAelectionObserverSOS']
